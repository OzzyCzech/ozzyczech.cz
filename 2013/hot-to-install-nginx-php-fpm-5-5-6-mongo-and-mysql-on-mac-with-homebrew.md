<!--
title : Hot to install nginx, PHP-fpm 5.5.6, mongo and MySql on mac with homebrew
author : Roman OÅ¾ana <ozana@omdesign.cz>
date : 26.11.2013 14:39:40
tags : access_log, error_log
-->

# Hot to install nginx, PHP-fpm 5.5.6, mongo and MySql on mac with homebrew

<div class="alert alert-info">
  ALERT!!! Latest version of followÂ procedure can be found hereÂ https://github.com/OzzyCzech/dotfiles/blob/master/readme.md
</div>

# <span style="color: inherit; font-family: inherit; font-size: 31.5px;">Preparation</span>

Download [Sublime editor][1] and create link `subl`:
...
Here is my example configuration:
    ...
    server {
      ...
      server_name           omdesign.dev;
                /Users/roman/Work/omdesign.cz/log/omdesign.dev.access.log;
                 /Users/roman/Work/omdesign.cz/log/omdesign.dev.error.log;
...
What about APC? See [stackoverflow][3] &#8211; APC have some problems but you can install emulated APC
...
PHP config files can be found here `subl /usr/local/etc/php/5.5/conf.d/`. You can change `php.ini` but its more more easly keept change is spearate file:
    ...
    subl /usr/local/etc/php/5.5/conf.d/99999-roman.ini
...
See my original gist here:Â https://gist.github.com/OzzyCzech/7658282

 [1]: http://www.sublimetext.com/
 [2]: http://brew.sh/
 [3]: http://stackoverflow.com/questions/9611676/is-apc-compatible-with-php-5-4-or-php-5-5
 [4]: https://github.com/addyosmani/dotfiles/blob/master/.brew