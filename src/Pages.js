				...
				<ul className="inline-flex list-none flex-wrap">
					{pages.map((pageNumber, index) =>
						<li className="my-3" key={index}>
							<a
								className={`py-3 px-5 mr-1 inline-block rounded hover:bg-gray-200 dark:hover:bg-gray-700 dark:text-gray-300 dark:border-opacity-20 ${pageNumber === current ? 'bg-gray-200 dark:bg-gray-700' : 'bg-gray-100 dark:bg-gray-800'}`}
