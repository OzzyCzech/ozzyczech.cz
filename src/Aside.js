...
export default ({page}) => {
	return (<aside>
			...
			<section className="list-group">
				<a className="list-group-item list-group-item-action" href="/"><Emoji from="🚀"/>Home</a>
				<a className="list-group-item list-group-item-action" href="/photo"><Emoji from="📷"/>Photo</a>
				<a className="list-group-item list-group-item-action" href="/apple">
					<svg xmlns="http://www.w3.org/2000/svg" width="14" viewBox="0 0 1000 1187.198" version="1.1" className="mr-3">
						<path fill="#a8b3bd"
				...
				<a className="list-group-item list-group-item-action" href="/awesome"><Emoji from="💄" />Awesome</a>
				<a className="list-group-item list-group-item-action" href="/links"><Emoji from="🔗" />Links</a>
