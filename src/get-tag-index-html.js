...
export function getTagIndexHtml(tags, pages) {
  return getDocument({
    title: 'Tags',
    main: `<article class="prose max-w-screen-lg lg:prose-lg mx-auto dark:prose-invert dark:prose-sky prose-a:no-underline hover:prose-a:underline my-12 prose-figure:m-0 prose-figure:p-0 p-4">
					<h1>#tags</h1>
					<div class="not-prose">
