...
- When referencing pages by slug in `src/sidebar.ts`, always use lowercase paths (e.g. `'ai/benchmarks'`, not `'AI/Benchmarks'`) — Starlight slugs are always lowercase regardless of file casing
